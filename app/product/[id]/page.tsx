  ...
  if (!product) {
    return (
      <div className="min-h-screen pt-40 text-center">
        ...
        <Link href="/collection" className="text-primary hover:underline mt-4 inline-block">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li><Link href="/collection" className="hover:text-foreground transition-colors">Kolleksiya</Link></li>
            <li>/</li>
