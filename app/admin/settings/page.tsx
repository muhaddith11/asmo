...
import { Save, Loader2, Phone, MapPin, Send, Instagram, Clock, Truck, CheckCircle2 } from 'lucide-react'
import { fetchSettings, updateSettings, StoreSettings, defaultSettings } from '@/lib/settings'
...
const fields: { key: keyof StoreSettings; label: string; placeholder: string; icon: typeof Phone }[] = [
  ...
  { key: 'instagram', label: 'Instagram (havola)', placeholder: 'https://instagram.com/...', icon: Instagram },
